...
<font size="+1"><b>Tagged Sets: a Secure and Transparent Coordination Medium</b>.
 ...
 In Jean-Marie Jacquet and Gian&nbsp;Pietro Picco, editors, <em>
  ...
  Science</em>, pages 252--267. Springer-Verlag, April 2005.</font><p>
...
VSMs:
<p><ol>
<em>Ease of use</em>. A tagged value naturally corresponds to the
  notion that data has certain attributes, expressed by the tag, which
  can be used for later retrieval.<p>
<em>Flexibility</em>. Tags are implemented as propositional logic
...
<em>Security</em>.  Our notion of tags naturally corresponds to
