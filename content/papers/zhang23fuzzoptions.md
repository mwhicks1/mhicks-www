...
layout: single
type: papers
url: /papers/zhang23fuzzoptions.html
---

<font size="+1"><b>Fuzzing Configurations of Program Options</b>.
...
<p>[&nbsp;<a href="https://dl.acm.org/doi/10.1145/3580597">http</a>&nbsp;]
<a name="zhang23fuzzoptions"></a><pre>
@article{zhang23fuzzoptions,
  title = {Fuzzing Configurations of Program Options},
  author = {Zenong Zhang and George Klees and Eric Wang and Michael Hicks and Shiyi Wei},
  journal = {{ACM} Transactions on Software Engineering and Methodology (TOSEM)},
  volume = 32,
  number = 2,
  month = mar,
  year = 2023,
  note = {A shorter version appeared at the 2022 Fuzzing Workshop}
}
</pre>
