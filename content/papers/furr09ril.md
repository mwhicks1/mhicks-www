...
<font size="+1"><b>The Ruby Intermediate Language</b>.
 ...
 In <em>Proceedings of the ACM SIGPLAN Dynamic Languages
  Symposium (DLS)</em>, pages 89--98, October 2009.</font><p>
  Ruby is a popular, dynamic scripting language that aims to &ldquo;feel
  natural to programmers&rdquo; and give users the &ldquo;freedom to choose&rdquo;
