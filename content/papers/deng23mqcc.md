...
layout: single
type: papers
url: /papers/deng23mqcc.html
---

<font size="+1"><b>Automating NISQ Application Design with Meta Quantum Circuits with
  Constraints (MQCC)</b>.
...
We also illustrate that MQCC can easily encode prior one-off NISQ application designs ---multi-programming (MP), crosstalk mitigation (CM)--- as well as a combination of their optimization goals (i.e., a combined MP-CM).
<p>[&nbsp;<a href="https://mwhicks1.github.io/papers/MQCC_TQC.pdf">.pdf</a>&nbsp;]
<a name="deng23mqcc"></a><pre>
@article{deng23mqcc,
