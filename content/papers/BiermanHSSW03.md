...
<font size="+1"><b>Dynamic Rebinding for Marshalling and Update with Destruct-time
 ...
 In <em>Proceedings of the ACM International Conference on
  Functional Programming (ICFP)</em>, pages 99--110, August 2003.</font><p>
...
The destruct-time semantics gives the basis for a &lambda;_marsh calculus
...
they are unpackaged.  We extend &lambda;_marsh with concurrency and
...
also as a basis for a &lambda;_update calculus with simple primitives to
...
of real-world mechanisms on a common semantic foundation.
  <p>[&nbsp;<a href="https://mwhicks1.github.io/papers/dynbind2-short.pdf">.pdf</a>&nbsp;]
