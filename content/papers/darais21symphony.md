...
layout: single
type: papers
url: /papers/darais21symphony.html
---

<font size="+1"><b>Symphony: A Concise Language Model for MPC</b>.
...
simply-typed &lambda; calculus extended with integers, sums,
...
<p>[&nbsp;<a href="https://mwhicks1.github.io/papers/symphony-short.pdf">.pdf</a>&nbsp;]
<a name="darais21symphony"></a><pre>
@inproceedings{darais21symphony,
  title = {Symphony: A Concise Language Model for {MPC}},
  booktitle = {Informal Proceedings of the Workshop on Foundations on Computer Secuirty (FCS)},
