...
layout: single
type: papers
url: /papers/hicks14polymonad.html
---
...
<font size="+1"><b>Polymonadic Programming</b>.
 ...
 In <em>Proceedings of the Fifth Workshop on Mathematically
  ...
  semantic model. We show how to equip a core language (called &lambda;<sub>PM</sub>)
  with syntactic support for programming with polymonads. Type
  inference and elaboration in &lambda;<sub>PM</sub> allows programmers to write
...
<a href="http://www.cs.umd.edu/~mwh/polymonads-impl.tgz">A prototype implementation of &lambda;<sub>PM</sub></a> is available.
