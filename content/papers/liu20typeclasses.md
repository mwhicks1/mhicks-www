...
layout: single
type: papers
url: /papers/liu20typeclasses.html
---

<font size="+1"><b>Verifying Replicated Data Types with Typeclass Refinements in Liquid
  Haskell</b>.
...
We demonstrate the utility of our extension by using Liquid Haskell to modularly verify that 34 instances satisfy the laws of five standard typeclasses. More substantially, we implement a framework for programming distributed applications based on <em>conflict-free replicated data types</em> (CRDTs). We define a typeclass whose Liquid Haskell type captures the mathematical properties CRDTs should satisfy; prove in Liquid Haskell that these properties are sufficient to ensure that replicas' states converge despite out-of-order update delivery; implement (and prove correct) several instances of our CRDT typeclass; and use them to build two realistic applications, a multi-user calendar event planner and a collaborative text editor.  
  <p>[&nbsp;<a href="https://mwhicks1.github.io/papers/lh-typeclasses.pdf">.pdf</a>&nbsp;]
<a name="liu20typeclasses"></a><pre>
