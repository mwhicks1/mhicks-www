...
layout: single
type: papers
url: /papers/sweet23symphony.html
---

<font size="+1"><b>Symphony: Expressive Secure Multiparty Computation with Coordination</b>.
...
<b>Inquiry</b> It can be hard to program MPCs correctly and
...
<b>Approach</b> We present Symphony, a new functional programming
...
parties. Symphony introduces <em>first-class shares</em> and
<em>first-class party sets</em> to provide unmatched language-level
expressive power with high efficiency.<p>

<b>Knowledge</b> Developing a core formal language called &lambda;-symphony,
...
<b>Grounding</b> In addition to developing the formal proofs, the
...
<em>secure shuffle</em> protocol based on a coordination pattern that no
prior language can express, and found it has far superior performance
to the standard alternative.<p>

<b>Importance</b> Programming MPCs is in increasing demand, with a
...
details. The &lambda;-symphony formalization of Symphony, and the proofs about
