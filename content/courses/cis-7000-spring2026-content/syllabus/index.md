---
title: "Syllabus"
subtitle: "Secure System Engineering and Management: A Data-Driven Approach"
date: 2026-01-01
author: "Mike Hicks"
draft: false
weight: 1
...
**Website**: Various course materials will be made available on the class website, which can be accessed at [https://mhicks.me/courses/CIS-7000-Spring2026](https://mhicks.me/courses/CIS-7000-Spring2026)
...
For most papers that we read in the class, students must submit a **review of each paper**. These will be used to drive discussion of the paper during class -- we cannot discuss what we do not read! Each review should be 300-500 words and consist of two parts: (1) a paragraph with key takeaways gleaned from the paper; (2) a few questions on topics that merit deep-dive discussion, or clarification, where each question should reference a specific finding, table, or claim
from the paper. Your review must have two clearly labeled sections: 'Key Takeaways' and 'Discussion Questions.' Note that part (1) should almost certainly not be complete (i.e., not an at-a-distance summary) but rather should be used to set up sufficient context and justification for the questions in part (2). Doing so ensures the questions are not surface-level, but rather are thought-through and engaging. You are writing a review, which means I want to see your opinion and your evidence for it. **Reviews are due at midnight the day before the class**, to avoid a late penalty of 20%. Reviews are **graded on a score of 0-5**, where
...
Further clarifications (added Jan 27, 2026): I updated the description above. Please adhere to the two-part structure; I don't just want a summary, or a summary and discussion questions blended together, I want a summary followed by clear discussion questions. For the discussion questions, I would like these to make specific references to the paper's claims and/or data, and not broadly within the overall category of the paper. A review that summarizes without offering your own analysis or questions will receive at most a 3.    
